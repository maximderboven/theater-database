...
-- Empty tables
    ...
    BEGIN
        ...
        /*EXECUTE IMMEDIATE ('ALTER TABLE PERFORMANCES MODIFY PERFORMANCE_ID GENERATED ALWAYS AS IDENTITY RESTART WITH 1');
        EXECUTE IMMEDIATE ('ALTER TABLE MOVIES MODIFY MOVIE_ID GENERATED ALWAYS AS IDENTITY RESTART WITH 1');
        EXECUTE IMMEDIATE ('ALTER TABLE LOCATIONS MODIFY LOCATION_ID GENERATED ALWAYS AS IDENTITY RESTART WITH 1');
        EXECUTE IMMEDIATE ('ALTER TABLE HALLS MODIFY HALL_ID GENERATED ALWAYS AS IDENTITY RESTART WITH 1');
        EXECUTE IMMEDIATE ('ALTER TABLE THEATHERS MODIFY THEATHER_ID GENERATED ALWAYS AS IDENTITY RESTART WITH 1');
        EXECUTE IMMEDIATE ('ALTER TABLE VIEWERS MODIFY VIEWER_ID GENERATED ALWAYS AS IDENTITY RESTART WITH 1');*/
        commit;
    END EMPTY_TABLES;
