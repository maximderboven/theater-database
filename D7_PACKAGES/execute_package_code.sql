...
-- Zipcodes
    ...
    commit;
-- Locations
    PKG_MOVIES.ADD_LOCATION('Galerie de la Reine', 26, 'BE', '1000');
    PKG_MOVIES.ADD_LOCATION('Brixtonlaan', 176, 'BE', '1000');
    PKG_MOVIES.ADD_LOCATION('Aven Ackers', 227, 'US', '10002');
    PKG_MOVIES.ADD_LOCATION('West 125th Street', 254, 'US', '10002');
    PKG_MOVIES.ADD_LOCATION('Pl. du Châtelet', 2, 'FR', '75000');
    PKG_MOVIES.ADD_LOCATION('Rue Bois des Fosses', 139, 'FR', '75000');
    PKG_MOVIES.ADD_LOCATION('Kleine-Gartmanplantsoen', 15, 'NL', '1015');
    PKG_MOVIES.ADD_LOCATION('Robert de Vriesstraat', 51, 'NL', '1015');
    PKG_MOVIES.ADD_LOCATION('D.F. Malan St', 25, 'ZA', '6665');
    PKG_MOVIES.ADD_LOCATION('Oost St', 1155, 'ZA', '6665');
    commit;
-- Viewers
    PKG_MOVIES.ADD_VIEWER('Diego', 'Luiken', TO_DATE('1962-05-22', 'yyyy-mm-dd'), 'M', 'diegoluiken@gmail.com',
                          'Brixtonlaan', 176, 'BE', '1000');
    PKG_MOVIES.ADD_VIEWER('Agnes', 'R. Sutton', TO_DATE('1945-06-20', 'yyyy-mm-dd'), 'X', 'agnessutton@gmail.com',
                          'Aven Ackers', 227, 'US', '10002');
    PKG_MOVIES.ADD_VIEWER('Ogier', 'Dennis', TO_DATE('2002-07-05', 'yyyy-mm-dd'), 'M', 'ogierdennis@gmail.com',
                          'Rue Bois des Fosses', 139, 'FR', '75000');
    PKG_MOVIES.ADD_VIEWER('Sylvia', 'B. Ralston', TO_DATE('1990-10-12', 'yyyy-mm-dd'), 'V', 'sylviaralston@gmail.com',
                          'Oost St', 1155, 'ZA', '6665');
    PKG_MOVIES.ADD_VIEWER('Shaniqua', 'Braams', TO_DATE('1962-05-10', 'yyyy-mm-dd'), 'V', 'shaniqua1962@gmail.com',
                          'Robert de Vriesstraat', 51, 'NL', '1015');
    commit;
-- Theathers
    PKG_MOVIES.ADD_THEATHER('Cinema Galeries', 0, '+3225147498',
                            'Galerie de la Reine', 26, 'BE', '1000');
    PKG_MOVIES.ADD_THEATHER('Apollo Theater', 0, '+12125315300',
                            'West 125th Street', 254, 'US', '10002');
    PKG_MOVIES.ADD_THEATHER('Théâtre de la Ville', 1, '+33142742277',
                            'Pl. du Châtelet', 2, 'FR', '75000');
    PKG_MOVIES.ADD_THEATHER('Pathé City', 1, '+31885152050',
                            'Kleine-Gartmanplantsoen', 15, 'NL', '1015');
    PKG_MOVIES.ADD_THEATHER('Artscape Theatre Centre', 1, '+27214109800',
                            'D.F. Malan St', 25, 'ZA', '6665');
    commit;
-- Halls
    PKG_MOVIES.ADD_HALL(150, 2, 13, 'MDX', 'Cinema Galeries', 'Galerie de la Reine', 26, '1000', 'BE');
    PKG_MOVIES.ADD_HALL(130, 2, 4, '4D', 'Apollo Theater', 'West 125th Street', 254, '1000', 'US');
...
-- Performances
    ...
    PKG_MOVIES.ADD_PERFORMANCE('Titanic', 'Apollo Theater', 'West 125th Street', 254, '1000', 'US', 2, 4,
...
-- Tickets
    ...
    PKG_MOVIES.ADD_TICKET('agnessutton@gmail.com',
                          ...
                          4, 12);
    PKG_MOVIES.ADD_TICKET('ogierdennis@gmail.com', 'Titanic', 'Apollo Theater', 'West 125th Street', 254, '1000', 'US',
